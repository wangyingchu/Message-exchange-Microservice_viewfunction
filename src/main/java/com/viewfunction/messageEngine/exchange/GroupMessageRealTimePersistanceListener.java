...
public class GroupMessageRealTimePersistanceListener implements RealTimeNotificationListener{
	...
	public void receivedObjectMessage(ObjectMessageEntry objectMessageEntry) {
		System.out.println("GroupMessageRealTimePersistanceListener");
